...
<div class="xoo-ml-phinput-cont custom-login-ui <?php echo esc_attr(implode(' ', $cont_class)); ?>">

    <div class="custom-login-header">
        Enter Mobile Number
    </div>

    <div class="custom-phone-input-wrapper <?php echo $cc_show === 'yes' ? 'xoo-ml-has-cc' : ''; ?>">

        <div class="custom-flag-code-container">
        ...
        <div class="xoo-ml-regphin">
            <input type="tel" class="xoo-ml-phone-input <?php echo esc_attr(implode(' ', $input_class)); ?>"
                name="xoo-ml-reg-phone" autocomplete="tel" value="<?php echo esc_attr($default_phone); ?>"
                placeholder="Enter Mobile Number" <?php echo $show_phone === 'required' ? 'required' : ''; ?> />
        </div>

    </div>
    <div class="custom-notify-offers">
    ...
    <!-- Hidden native CC input to maintain functionality -->
    <input type="hidden" name="xoo-ml-reg-phone-cc" value="+91">
